...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'New Advertisement'])
    ...
    <div class="card-body p-3">
        <form id="form" action="" method="" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control start_date" name="start_date" id="start_date" placeholder="Enter url">
            </div>
            <div class="mb-3">
                <label for="end_date" class="form-label">End Date</label>
                <input type="date" class="form-control end_date" name="end_date" id="end_date" placeholder="Enter url">
            </div>
    ...
    $(document).ready(function() {
        $("#form").validate({
            ...
            , submitHandler: function(form) {
                ...
                var url = '{{url("create-advertisement")}}';
